...
////////////////////////////////////////////////////////////////////////////////
var OrbitCameraKeyboardMouse = pc.createScript("orbitCameraInputMouse");

OrbitCameraKeyboardMouse.attributes.add("orbitSensitivity", {
  type: "number",
  default: 0.3,
...
OrbitCameraKeyboardMouse.attributes.add("distanceSensitivity", {
  type: "number",
  default: 0.15,
...
OrbitCameraKeyboardMouse.prototype.initialize = function () {
...
OrbitCameraKeyboardMouse.fromWorldPoint = new pc.Vec3();
OrbitCameraKeyboardMouse.toWorldPoint = new pc.Vec3();
OrbitCameraKeyboardMouse.worldDiff = new pc.Vec3();

OrbitCameraKeyboardMouse.prototype.pan = function (screenPoint) {
  var fromWorldPoint = OrbitCameraKeyboardMouse.fromWorldPoint;
  var toWorldPoint = OrbitCameraKeyboardMouse.toWorldPoint;
  var worldDiff = OrbitCameraKeyboardMouse.worldDiff;
...
OrbitCameraKeyboardMouse.prototype.onMouseDown = function (event) {
  switch (event.button) {
...
OrbitCameraKeyboardMouse.prototype.onMouseUp = function (event) {
  switch (event.button) {
    case pc.MOUSEBUTTON_LEFT:
      this.lookButtonDown = false;
      break;
...
OrbitCameraKeyboardMouse.prototype.onMouseMove = function (event) {
...
OrbitCameraKeyboardMouse.prototype.onMouseWheel = function (event) {
  this.orbitCamera.distance -= event.wheel * this.distanceSensitivity * (this.orbitCamera.distance * 0.1);
  event.event.preventDefault();
};

OrbitCameraKeyboardMouse.prototype.onMouseOut = function (event) {
  this.lookButtonDown = false;
  this.panButtonDown = false;
};
